    ...
    <section className="bg-gray-900 text-white">
      <div className="mx-auto max-w-screen-xl px-4 py-8 sm:px-6 sm:py-12 lg:px-8 lg:py-16">
        <div className="mx-auto max-w-lg text-center">
          ...
          Kickstart your marketing with innovative strategies and a robust online presence that drives results. Leverage the power of social media, content marketing, and targeted advertising to reach your ideal audience and boost brand visibility.</p>
        </div>
        ...
        <div className="mt-8 grid grid-cols-1 gap-8 md:grid-cols-2 lg:grid-cols-3">
          ...
          >
            ...
            <p className="mt-1 text-sm text-gray-300">
            Join the [Your Store Name] community and stay updated on the latest trends, special offers, and new arrivals. Subscribe to our newsletter and follow us on social media </p>
          </a>
        </div>
